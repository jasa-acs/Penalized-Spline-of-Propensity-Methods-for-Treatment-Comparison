...
simulateData=function(sampleSize, level, seed.num, linear){
  ...
  y=y00*as.numeric(A0==0 & A1==0) + y01*as.numeric(A0==0 & A1==1) + y10*as.numeric(A0==1 & A1==0) + y11*as.numeric(A0==1 & A1==1)
  
  simdat <- data.frame(L0, A0, L1, L1_0t, L1_1t, L1b_0t, L1b_1t, A1, y, y00, y10, y01, y11, L0b, L1b)
  simdat$L1L1bInt = simdat$L1 * simdat$L1b
