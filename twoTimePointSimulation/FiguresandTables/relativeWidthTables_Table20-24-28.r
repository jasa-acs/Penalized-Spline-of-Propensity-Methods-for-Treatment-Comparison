...
measure1="avg.Width" ##for delta11
measure2="avg.Width.1"  ##for delta10
measure3="avg.Width.2"  ##for delta01
...
for( num in 1:3) {
  ...
  bench1=c(iptwL[1,which(names(iptwL)==measure1)],iptwL[2,which(names(iptwL)==measure1)],iptwL[3,which(names(iptwL)==measure1)], 
           iptwL[1,which(names(iptwL)==measure2)],iptwL[2,which(names(iptwL)==measure2)],iptwL[3,which(names(iptwL)==measure2)], 
           iptwL[1,which(names(iptwL)==measure3)],iptwL[2,which(names(iptwL)==measure3)],iptwL[3,which(names(iptwL)==measure3)])
  
  bench2=c(iptwN[1,which(names(iptwN)==measure1)],iptwN[2,which(names(iptwN)==measure1)],iptwN[3,which(names(iptwN)==measure1)], 
           iptwN[1,which(names(iptwN)==measure2)],iptwN[2,which(names(iptwN)==measure2)],iptwN[3,which(names(iptwN)==measure2)], 
           iptwN[1,which(names(iptwN)==measure3)],iptwN[2,which(names(iptwN)==measure3)],iptwN[3,which(names(iptwN)==measure3)])  
  ...
  write.table(format(biasAll, digits=0), paste(DIREC, "paperTables/sampleSize", sampleSize, "relativeWidthTable.txt",sep=""), sep="", quote=F, col.names=F)
