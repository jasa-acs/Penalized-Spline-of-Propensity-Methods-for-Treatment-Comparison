...
pdf(paste(DIREC, "paperPlots/Figure6_NonLinear_RelativeRMSE_IPTW.pdf", sep=""))
...
#       col=plot_colors, cex=1, horiz = TRUE, pch=c(17,8,1,9), xpd = TRUE, text.font=1.5, pt.cex=1.5)
