...
pdf(paste(DIREC, "paperPlots/Figure7_Linear_Coverage.pdf", sep=""))
...
abline(h=5)
arrows(3, max(temp)-0.5, 3, max(temp), length=0.1)
text(2.65, max(temp)-1, paste("IPTW=",round(iptw3y[3],2)), col="green4")
...
arrows(1.95, max(temp)-0.5, 1.95, max(temp), length=0.1)
text(1.93, max(temp)-1.5, paste("G-COMP=",round(gcompute2y[2],2)), col="black")
text(1.9, max(temp)-1, paste("IPTW=",round(iptw2y[2],2)), col="green4")

arrows(1, max(temp)-0.5, 1, max(temp), length=0.1)
text(1.23, max(temp)-1.5, paste("IPTW=",round(iptw2y[1],2)), col="green4")
mtext(expression(bold(paste(Delta, "10"))), line = 0, at=2, side=3)
...
arrows(2, max(temp)-0.5, 2, max(temp), length=0.1)
text(1.9, max(temp)-2.7, paste("G-COMP=",round(gcompute3y[2],2)), col="black")
text(1.9, max(temp)-2, paste("IPTW=",round(iptw3y[2],2)), col="green4")

arrows(1, max(temp)-0.5, 1, max(temp), length=0.1)
text(1.25, max(temp)-1, paste("IPTW=",round(iptw3y[1],2)), col="green4")
mtext(expression(bold(paste(Delta, "10"))), line = 0, at=2, side=3)
