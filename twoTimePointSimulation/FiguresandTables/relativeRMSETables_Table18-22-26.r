...
measure1="RMSE"  ###for delta11
measure2="RMSE.1"  ##for delta10
measure3="RMSE.2"  ##for delte01
...
for( num in 1:3) {
  ...
  write.table(format(biasAll, digits=0), paste(DIREC, "paperTables/sampleSize", sampleSize, "relativeRMSETable.txt",sep=""), sep="", quote=F, col.names=F)
